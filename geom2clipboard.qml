...
<qgis version="2.14.5-Essen" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="singleSymbol" enableorderby="0">
    <symbols>
      <symbol alpha="0.423529" clip_to_extent="1" type="fill" name="0">
  ...
  <attributeactions>
    <actionsetting action="from qgis import ( core as QgsCore,gui as QgsGui, utils as QgsUtils )&#xa;from PyQt4 import QtGui&#xa;&#xa;crs4326 = QgsCore.QgsCoordinateReferenceSystem( 4326, QgsCore.QgsCoordinateReferenceSystem.EpsgCrsId )&#xa;layer = qgis.utils.iface.activeLayer()&#xa;crsLayer = layer.crs()&#xa;wkt = &quot;[% geom_to_wkt( $geometry )%]&quot;&#xa;geom = QgsGeometry.fromWkt( wkt )&#xa;bbox = geom.boundingBox()&#xa;if not crsLayer == crs4326:&#xa;  ct = QgsCoordinateTransform( crsLayer, crs4326 ) &#xa;  geom.transform( ct )&#xa;  bbox = geom.boundingBox()&#xa;del geom&#xa;spat = &quot;%f %f %f %f&quot; % ( bbox.xMinimum(), bbox.yMinimum(), bbox.xMaximum(), bbox.yMaximum() )&#xa;strClip = &quot;ogrinfo -spat %s datasource_name [layer]&quot; % spat&#xa;cb = QtGui.QApplication.clipboard()&#xa;cb.setText( strClip, mode=cb.Clipboard )&#xa;&#xa;nameAction = &quot;'ogrinfo -spat' to Clipboard&quot;&#xa;nameLayer = layer.name()&#xa;msgBar =  QgsUtils.iface.messageBar()&#xa;msg = &quot;Copied Clipboard. Using '%s' how CRS reference!&quot; % nameLayer&#xa;msgBar.pushMessage( &quot;Action %s&quot; % nameAction,  msg, QgsGui.QgsMessageBar.INFO, 4 )&#xa;" icon="" capture="0" type="1" name="'ogrinfo -spat' to Clipboard"/>
    <actionsetting action="from qgis import ( core as QgsCore,gui as QgsGui, utils as QgsUtils )&#xa;from PyQt4 import QtGui&#xa;&#xa;crs4326 = QgsCore.QgsCoordinateReferenceSystem( 4326, QgsCore.QgsCoordinateReferenceSystem.EpsgCrsId )&#xa;layer = qgis.utils.iface.activeLayer()&#xa;crsLayer = layer.crs()&#xa;wkt = &quot;[% geom_to_wkt( $geometry )%]&quot;&#xa;geom = QgsGeometry.fromWkt( wkt )&#xa;bbox = geom.boundingBox()&#xa;if not crsLayer == crs4326:&#xa;  ct = QgsCoordinateTransform( crsLayer, crs4326 ) &#xa;  geom.transform( ct )&#xa;  bbox = geom.boundingBox()&#xa;del geom&#xa;projwin = &quot;%f %f %f %f&quot; % ( bbox.xMinimum(), bbox.yMaximum(), bbox.xMaximum(), bbox.yMinimum() )&#xa;strClip = 'gdal_translate -projwin %s -projwin_srs &quot;EPSG:4326&quot; datasource_name   datadest_name'  % projwin&#xa;cb = QtGui.QApplication.clipboard()&#xa;cb.setText( strClip, mode=cb.Clipboard )&#xa;&#xa;nameAction = &quot;'gdal_translate -projwin' to Clipboard&quot;&#xa;nameLayer = layer.name()&#xa;msgBar =  QgsUtils.iface.messageBar()&#xa;msg = &quot;Copied Clipboard. Using '%s' how CRS reference!&quot; % nameLayer&#xa;msgBar.pushMessage( &quot;Action %s&quot; % nameAction,  msg, QgsGui.QgsMessageBar.INFO, 4 )&#xa;" icon="" capture="0" type="1" name="'gdal_translate -projwin' to Clipboard"/>
    <actionsetting action="from qgis import ( core as QgsCore,gui as QgsGui, utils as QgsUtils )&#xa;from PyQt4 import QtGui&#xa;&#xa;crs4326 = QgsCore.QgsCoordinateReferenceSystem( 4326, QgsCore.QgsCoordinateReferenceSystem.EpsgCrsId )&#xa;layer = qgis.utils.iface.activeLayer()&#xa;crsLayer = layer.crs()&#xa;wkt = &quot;[% geom_to_wkt( $geometry )%]&quot;&#xa;geom = QgsGeometry.fromWkt( wkt )&#xa;if not crsLayer == crs4326:&#xa;  ct = QgsCoordinateTransform( crsLayer, crs4326 ) &#xa;  geom.transform( ct )&#xa;  wkt = geom.exportToWkt()&#xa;del geom&#xa;strClip = &quot;'%s'&quot; % wkt&#xa;cb = QtGui.QApplication.clipboard()&#xa;cb.setText( strClip, mode=cb.Clipboard )&#xa;&#xa;nameAction = &quot;'WKT' to Clipboard&quot;&#xa;nameLayer = layer.name()&#xa;msgBar =  QgsUtils.iface.messageBar()&#xa;msg = &quot;Copied to Clipboard. Using '%s' how CRS reference!&quot; % nameLayer&#xa;msgBar.pushMessage( &quot;Action %s&quot; % nameAction,  msg, QgsGui.QgsMessageBar.INFO, 4 )&#xa;" icon="" capture="0" type="1" name="'WKT' to Clipboard"/>
    <actionsetting action="from qgis import ( core as QgsCore,gui as QgsGui, utils as QgsUtils )&#xa;from PyQt4 import QtGui&#xa;&#xa;crs4326 = QgsCore.QgsCoordinateReferenceSystem( 4326, QgsCore.QgsCoordinateReferenceSystem.EpsgCrsId )&#xa;layer = qgis.utils.iface.activeLayer()&#xa;crsLayer = layer.crs()&#xa;wkt = &quot;[% geom_to_wkt( $geometry )%]&quot;&#xa;geom = QgsGeometry.fromWkt( wkt )&#xa;json = geom.exportToGeoJSON()&#xa;if not crsLayer == crs4326:&#xa;  ct = QgsCoordinateTransform( crsLayer, crs4326 ) &#xa;  geom.transform( ct )&#xa;  json = geom.exportToGeoJSON()&#xa;del geom&#xa;strClip = &quot;'%s'&quot; % json&#xa;cb = QtGui.QApplication.clipboard()&#xa;cb.setText( strClip, mode=cb.Clipboard )&#xa;&#xa;nameAction = &quot;'GeoJson' to Clipboard&quot;&#xa;nameLayer = layer.name()&#xa;msgBar =  QgsUtils.iface.messageBar()&#xa;msg = &quot;Copied to Clipboard. Using '%s' how CRS reference!&quot; % nameLayer&#xa;msgBar.pushMessage( &quot;Action %s&quot; % nameAction,  msg, QgsGui.QgsMessageBar.INFO, 4 )&#xa;" icon="" capture="0" type="1" name="'GeoJson' to Clipboard"/>
  </attributeactions>
  <editform>.</editform>
  <editforminit/>
